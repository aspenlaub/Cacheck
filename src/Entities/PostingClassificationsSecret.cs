...
namespace Aspenlaub.Net.GitHub.CSharp.Cacheck.Entities {
    public class PostingClassificationsSecret : ISecret<PostingClassifications> {
        ...
        public PostingClassifications DefaultValue => vDefaultValue ??= new PostingClassifications { new PostingClassification { Credit = true, Clue = "a clue", Classification = "a classification"} };
