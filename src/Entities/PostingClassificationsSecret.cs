...
public class PostingClassificationsSecret : ISecret<PostingClassifications> {
    ...
    public PostingClassifications DefaultValue => _PrivateDefaultValue ??= new PostingClassifications { new() { Credit = true, Clue = "a clue", Classification = "a classification"} };
